...
android {
    namespace = "com.ironsidemedical.connect"
    compileSdk = 35
    ...
    defaultConfig {
        ...
        // IEC 62304 traceability: embed build metadata into APK
        buildConfigField("String", "BUILD_TIMESTAMP", "\"${System.currentTimeMillis()}\"")
        buildConfigField("String", "SOFTWARE_VERSION", "\"1.0.0\"")
        buildConfigField("String", "SOFTWARE_SAFETY_CLASS", "\"CLASS_B\"")
    ...
    buildTypes {
        debug {
            ...
            isDebuggable = true
            buildConfigField("Boolean", "AUDIT_VERBOSE", "true")
        }
        release {
